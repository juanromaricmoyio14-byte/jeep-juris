  ...
  return (
    <div className="max-w-[90%] space-y-4 rounded-2xl rounded-tl-sm border border-border bg-background p-5 text-sm shadow-sm">
        ...
        <Accordion.Root type="single" collapsible className="w-full mt-4">
          ...
          >
            <Accordion.Header className="flex">
              <Accordion.Trigger className="flex flex-1 items-center justify-between py-3 px-4 text-sm font-semibold hover:bg-muted/50 transition-all [&[data-state=open]>svg]:rotate-180 text-primary">
                Voir les sources (textes applicables)
      ...
      <Block title={t("agent.analysis")}>
        <p className="whitespace-pre-wrap leading-relaxed mt-2">{response.analyse}</p>
      </Block>
