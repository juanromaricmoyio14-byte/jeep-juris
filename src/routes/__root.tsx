    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          An unexpected error occurred. Please try again. / Une erreur inattendue est survenue.
          Veuillez réessayer.
        </p>
        <button
          onClick={() => {
    ...
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        ...
        <nav className="fixed bottom-0 left-0 right-0 z-[100] flex h-16 bg-background border-t border-border md:hidden px-2 pb-safe">
          <Link
            to="/"
            className="flex flex-1 flex-col items-center justify-center gap-1 text-muted-foreground hover:text-primary transition-colors min-h-[44px]"
